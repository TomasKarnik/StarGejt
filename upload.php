...
// Check file size
if ($_FILES["picture"]["size"] > 16777216) { // 16 MB in bytes
...
$sql = "INSERT INTO stargate_data (spz, firma, osoba, typ, poznámka, důvod, saved_time, picture) 
        VALUES ('$spz', '$firma', '$osoba', '$typ', '$poznámka', '$důvod', '$saved_time', '$target_file')";
